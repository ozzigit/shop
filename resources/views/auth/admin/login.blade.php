                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    ...
                                    <form method="POST" action="{{  route('admin.auth.login-admin') }}">
                                        @csrf
                                        <div class="mb-3">
                                            <label>Email</label>
                                            <input class="form-control form-control-lg @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter your email" />
                                            @error('email')
